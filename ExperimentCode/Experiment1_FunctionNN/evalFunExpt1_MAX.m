function [z, temp,l_i,u_i] = evalFunExpt1_MAX(pixelOptIndex,x,temp)
...
elseif pixelOptIndex > 1
    ...
    z1 = evalFunExpt1_MAX(pixelOptIndex,x1,temp);
    z2 = evalFunExpt1_MAX(pixelOptIndex,x2,temp);
    z_Allsorted = [x1,z1;x2,z2];
    y_2 = calculate_y_i(z_Allsorted,K);
    w_y_2 = evalFunExpt1_MAX(pixelOptIndex,y_2,temp);
    ...
    while(k < maxIter && u_i-l_i > bounderror)
        ...
        w_y_i = evalFunExpt1_MAX(pixelOptIndex,y_i,temp);
