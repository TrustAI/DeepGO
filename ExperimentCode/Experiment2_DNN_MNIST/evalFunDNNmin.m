function [z, imageTemp, l_i,u_i] = evalFunDNNmin(pixelOptIndex,x,imageTemp)
...
elseif pixelOptIndex > 1
    ...
    z1 = evalFunDNNmin(pixelOptIndex,x1,imageTemp);
    z2 = evalFunDNNmin(pixelOptIndex,x2,imageTemp);
    z_Allsorted = [x1,z1;x2,z2];
    y_2 = calculate_y_i(z_Allsorted,K);
    w_y_2 = evalFunDNNmin(pixelOptIndex,y_2,imageTemp);
    ...
    while(k < maxIter && u_i-l_i > bounderror )
        ...
        w_y_i = evalFunDNNmin(pixelOptIndex,y_i,imageTemp);
        y_iplus_1 =  calculate_y_i(z_Allsorted(z_starIndex+1:z_starIndex+2,:),K);
        w_y_iplus_1 = evalFunDNNmin(pixelOptIndex,y_iplus_1,imageTemp);
